...
<section class="panel"><h2>${escapeHtml(labels.trend)}</h2><div class="bars" id="trend"></div></section><div class="grid2"><section class="panel"><h2>${escapeHtml(labels.breakdown)}</h2><div class="bars" id="breakdown"></div></section><section class="panel"><h2>${escapeHtml(labels.typeBreakdown)}</h2><div class="bars" id="type-breakdown"></div></section></div>
