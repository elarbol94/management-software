...
export function AttachmentPanel({ entityType, entityId, initial }: { entityType: "wikiPage" | "wikiSource"; entityId: string; initial: Attachment[] }) {
