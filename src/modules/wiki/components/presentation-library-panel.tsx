...
export function PresentationLibraryPanel({ id, selectedId, canEdit, flush, onTheme, onTemplate, onAsset, onIcon, onSelect }: {
  ...
  return <div className="mb-4 space-y-3 border-b pb-4">
    ...
    <details className="space-y-3"><summary className="cursor-pointer text-sm font-semibold">{t("designLibrary")}</summary>
    ...
    <details className="space-y-3"><summary className="cursor-pointer text-sm font-semibold">{t("assetLibrary")}</summary>
    ...
    <details className="space-y-3"><summary className="cursor-pointer text-sm font-semibold">{t("sharing")}</summary>
      {studio?.role === "owner" && <>
