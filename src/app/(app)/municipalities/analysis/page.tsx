...
import { getMunicipalityAnalysisForUser, listMunicipalityAnalysesForUser, listMunicipalityMetricsForUser } from "@/modules/municipalities/queries";
...
export default async function MunicipalitiesAnalysisPage({ searchParams }: { searchParams: Promise<{ analysis?: string }> }) {
  ...
  return <MunicipalityAnalysisClient analyses={analyses} initialAnalysis={active} metrics={listMunicipalityMetricsForUser(user.id)} />;
}
