...
export default async function WikiPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <WikiShell
    page={{ id: page.id, title: page.title, slug: page.slug, contentJson: page.contentJson, status: page.status, citationLocale: page.citationLocale, version: page.version }}
    ...
    comments={getPageComments(page.id)} users={listUsers()}
