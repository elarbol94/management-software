...
CREATE INDEX `funding_projects_template_idx` ON `funding_projects` (`template_id`);--> statement-breakpoint
INSERT INTO `funding_program_templates` (`id`, `key`, `name`, `description`, `structure_json`, `is_custom`, `archived`, `created_at`, `updated_at`) VALUES
	('funding-template-ffg-klf-3-2', 'ffg-klf-3-2', 'FFG KLF 3.2', 'Konfigurierbare Produktvorlage; aktuelle Richtlinie und Förderentscheidung sind separat zu prüfen.', '{"costTypes":["personnel","external_services","material","investments","travel","rent","overhead","program_specific"]}', false, false, 1784491796611, 1784491796611),
	('funding-template-aws-preseed-seed', 'aws-preseed-seedfinancing', 'aws Preseed / Seedfinancing', 'Konfigurierbare Produktvorlage; keine verbindliche Rechts- oder Förderberatung.', '{"costTypes":["personnel","external_services","material","investments","travel","rent","overhead","program_specific"]}', false, false, 1784491796611, 1784491796611),
	('funding-template-aws-first-incubator', 'aws-first-incubator', 'aws First Incubator', 'Konfigurierbare Produktvorlage; Programmdetails können sich ändern.', '{"costTypes":["personnel","external_services","material","investments","travel","rent","overhead","program_specific"]}', false, false, 1784491796611, 1784491796611),
	('funding-template-sfg-startklar', 'sfg-startklar', 'SFG Start!Klar', 'Konfigurierbare Produktvorlage; Programmdetails können sich ändern.', '{"costTypes":["personnel","external_services","material","investments","travel","rent","overhead","program_specific"]}', false, false, 1784491796611, 1784491796611),
	('funding-template-sfg-startklar-plus', 'sfg-startklar-plus', 'SFG Start!Klar plus', 'Konfigurierbare Produktvorlage; Programmdetails können sich ändern.', '{"costTypes":["personnel","external_services","material","investments","travel","rent","overhead","program_specific"]}', false, false, 1784491796611, 1784491796611),
	('funding-template-custom', 'custom', 'Benutzerdefiniert', 'Freie konfigurierbare Struktur ohne vorgegebene Programmregeln.', '{"costTypes":["personnel","external_services","material","investments","travel","rent","overhead","program_specific"]}', true, false, 1784491796611, 1784491796611);
